...
const Configurator__Select = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      "select-options": fieldConfig.options?.join(";") || "",
    },
  });
      ...
      <div className="w-full flex">
        ...
        <div className="flex-1 border-r">
          <AccordionTrigger className="p-2 hover:cursor-pointer">
            Select - {fieldConfig.label || fieldConfig.name}
          </AccordionTrigger>
...
export default Configurator__Select;
